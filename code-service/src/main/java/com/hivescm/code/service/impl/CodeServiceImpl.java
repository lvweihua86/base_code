...
import com.hivescm.code.mapper.CodeIDItemMapper;
import com.hivescm.code.mapper.CodeIdMapper;
import com.hivescm.code.mapper.SeriaNumberMapper;
import com.hivescm.code.mapper.SingleSeriaNumberMapper;
import com.hivescm.code.pojo.CodeIDItem;
import com.hivescm.code.pojo.CodeId;
import com.hivescm.code.pojo.SeriaNumber;
import com.hivescm.code.service.CodeIdService;
import com.hivescm.code.service.OrgService;
...
public class CodeIdServiceImpl implements CodeIdService {
	...
	public String generateID(String businessCode, String orgId, String json) throws
         ...
         *  value -- code:time_format:code_type:zero_reason:is_default
         */
	...
	public void initCodeIDTemplate() {
		...
		for (CodeId codeId : usedCodeIds) {
			...
			try {
                /*   具体的编码规则 对应的 业务实体+组织id
		         *  key -- DYBM_orgId_businessCode
		         *  value -- code:time_format:code_type:zero_reason:is_default:is_break_code
		         */
